...
OUTPUT_DIR="improvement_3/testleaderboards/0121Q30B_Lovink_phc_no_vllm"
...
for GPU_ID in {0..7}; do
    ...
    # 使用nohup确保进程在后台运行
    nohup env CUDA_VISIBLE_DEVICES=${GPU_ID} python improvement_3/inference_no_vllm.py \
